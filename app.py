...
def render_results(results) -> None:
    ...
    with left:
        ...
        if results.strengths:
            ...
            st.caption(f"No factor reached the strength threshold of {cfg.STRENGTH_THRESHOLD:.0f}.")
    with right:
        ...
        if results.barriers:
            ...
            st.caption(f"No factor fell below the barrier threshold of {cfg.BARRIER_THRESHOLD:.0f}.")
